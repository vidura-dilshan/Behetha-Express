...
import Shppingcartinterface from './Shppingcartinterface'
...
const Shoppingcart = () => {
  ...
  useEffect(() => {
    ...
    function addProductToCart(title, price, productImg) {
      ...
      for (var i = 0; i < cartItemsNames.length; i++) {
        if (cartItemsNames[i].innerText == title) {
          alert(
            "You already added this item to the cart./n If you want to add more, change the quantity in the cart."
          );
          return;
        }
      }
    ...
    //       'Kaviru_paymentgateway.html?finalTotal=' +
    //       finalTotal +
    //       '&username=' +
    //       username +
    //       '&contactway=' +
