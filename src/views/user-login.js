  ...
  return (
    <div className="user-login-container">
      ...
      <div className="user-login-container1">
        ...
        <Link to="/pharmacist-login" className="user-login-text">
          <span>Pharmacist</span>
        </Link>
        <Link to="/" className="user-login-text02">
          <span>USER</span>
        </Link>
        <img
          alt="Rectangle38545"
        ...
        />
        <button  className="user-login-navlink2 button"
         type='submit'
         value={"signIn"}>
          Login
        </button>
        ...
        <h1 className="user-login-text04">
          <span>TRUST IN US FOR ALL YOUR </span>
          <br></br>
          <span>HEALTH CARE NEEDS</span>
          <br></br>
        </h1>
        <a href='http://localhost:8501' className="user-login-navlink4">
          <img
            alt="Layer33014"
      ...
      <div className="user-login-container3">
        <div className="user-login-group28">
          ...
          <div className="user-login-group27">
            <div className="user-login-frame1">
              ...
              <Link to="/ambulance-service" className="user-login-navlink6">
                <img
                  alt="Layer18425"
              ...
              <Link to="/health-store-user" className="user-login-navlink7">
                <img
                  alt="Layer18328"
            ...
            <div className="user-login-frame84">
              <span className="user-login-text15">
                <span>Medicine Delivery</span>
                <br></br>
                <span> Serv ices</span>
              </span>
              <span className="user-login-text19">
                <span>
                  Ambulance
                  <span
              ...
              <span className="user-login-text23">Health Store</span>
            </div>
          </div>
        </div>
        <span className="user-login-text24">
          <span>
        ...
        <span className="user-login-text40">
          <span>. . . . .</span>
        </span>
        <div className="user-login-group24">
          <span className="user-login-text42">
            <span className="user-login-text43">Get an Extra </span>
            <span className="user-login-text44">50%</span>
            <span className="user-login-text45"> Off</span>
            <br className="user-login-text46"></br>
          </span>
        </div>
        <img
          alt="image63627"
