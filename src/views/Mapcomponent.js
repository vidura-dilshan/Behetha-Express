...
const MapComponent = () => {
    ...
    const apiKey = 'AIzaSyAyQyRdKCCCxNHgi0jqt2ulXQ17HMd9LcU'; // Replace with your Google Maps API key
    ...
    return (
        ...
        <p className="map-text1">Your Location: {currentLocation ? `${currentLocation.lat}, ${currentLocation.lng}` : 'Loading...'}</p>
        <h1 className="map-text1"><br></br>Your Location Sent to the Ambulance Service Now <br></br>Please wait for the Arrival<br></br></h1>
        <Link to="/ambulance-service">
        <button className="map-button button">Go Back</button>
        </Link>
